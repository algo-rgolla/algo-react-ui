...
import { DELETE_ALGO_PORTFOLIO_HISTORY_URL, DELETE_PORTFOLIO_HISTORY_URL } from "../../shared/utils/constants/apiConstants";

const AlgoPortfolioHistory: React.FC = () => {
    ...
    const fetchData = async () => {
      ...
      try {
        const response = await apiClient.get(
          `${apiUrl}/api/algoportfolio/algo-portfolio-history?ScanName=${portfolioHistoryType}`
        );
  ...
  const handleDeleteWatchlistItem = (id: number) => {
    const url = DELETE_ALGO_PORTFOLIO_HISTORY_URL(id);
    deleteItem(url);
...
export default AlgoPortfolioHistory;
